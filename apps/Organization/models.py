...
class Org(models.Model):
    ...
    # we set this admin field here to NULL. TODO : Do we allow multiple admins for org as well?
...
class Team(models.Model):
    ...
    # Org to which the team belongs. If the parent is Org is deleted, the teams under it also need to be too.
